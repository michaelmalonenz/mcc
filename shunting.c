...
static int getRelativeOperatorPrecedence(MCC_OPERATOR op)
{
   static const int precedents[NUM_OPERATORS] = {
      ...
      [OP_DECREMENT_POST] = 3, [OP_INCREMENT_POST] = 3,
      [OP_DEREFERENCE] = 4, [OP_ADDRESS_OF] = 4,
      [OP_NOT] = 5,
      [OP_NEGATE] = 6,
      [OP_SIZEOF] = 7,
      [OP_MULTIPLY] = 8, [OP_DIVIDE] = 8,
      [OP_MODULO] = 9,
      [OP_ADD] = 10, [OP_MINUS] = 10,
      [OP_R_SHIFT] = 11, [OP_L_SHIFT] = 11,
      [OP_LESS_THAN] = 12, [OP_GREATER_THAN] = 12,
      [OP_LESS_EQUAL] = 13, [OP_GREATER_EQUAL] = 13, [OP_COMPARE_TO] = 13,
      [OP_NOT_EQUAL] = 14,
      [OP_BITWISE_AND] = 15,
      ...
      [OP_TERNARY_IF] = 20, [OP_TERNARY_ELSE] = 20,
