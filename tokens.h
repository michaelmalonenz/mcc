...
const enum key_index { KEY_AUTO, KEY_BREAK, KEY_CASE, KEY_CHAR, KEY_CONST, KEY_CONTINUE, KEY_DEFAULT, KEY_DO, KEY_DOUBLE,
...
const enum c99_key_index { C99_KEY_BOOL, C99_KEY_COMPLEX, C99_KEY_IMAGINARY, C99_KEY_INLINE, C99_KEY_RESTRICT };
...
const enum operator_index {OP_ADD, OP_MINUS, OP_DIVIDE, OP_MULTIPLY, OP_MODULO, OP_DECREMENT, OP_INCREMENT,
						   ...
						   OP_TERNARY_ELSE, OP_COMMA};

const char **symbols = { "{", "}", "[", "]", ";", "(", ")", "\"", "'", "\\" };
const enum symbol_index {SYM_OPEN_BRACE, SYM_CLOSE_BRACE, SYM_OPEN_BRACKET, SYM_CLOSE_BRACKET, SYM_SEMI_COLON, 
						 SYM_OPEN_PAREN, SYM_CLOSE_PAREN, SYM_DOUBLE_QUOTE, SYM_SINGLE_QUOTE, SYM_ESCAPE};
#endif /* MCC_TOKENS_H_ */
